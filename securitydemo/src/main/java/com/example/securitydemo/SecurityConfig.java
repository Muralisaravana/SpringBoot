...
public class SecurityConfig {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		 ...
		 * User.withUsername("user1") .password(passwordEncoder().encode("password1"))
		 * .roles("USER") .build();
		 * 
		 ...
		 * userDetailsManager.createUser(admin); return userDetailsManager; //return new
		 * InMemoryUserDetailsManager(user1,admin); }
		 * 
		 */	@Bean
